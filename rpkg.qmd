...
:::
::: {.column width="20%"}
![](metasurvey_new.svg){width=100, height=100}
:::
:::
::: {.column width="80%"}
::: {.justify}
...
Additionally, the package provides a set of functions to facilitate the variance estimation of complex survey designs, and to facilitate the analysis of complex survey designs using the survey package.
...
::: {.column width="20%"}
![](RLadies_Montevideo.png){width=100, height=100}
:::
:::
